      ...
      <main className="flex-1 bg-[var(--card)] rounded-2xl flex flex-col overflow-hidden relative">
        ...
        <div className="flex-1 overflow-y-auto px-7 pt-6 pb-32" style={{ background: "linear-gradient(to bottom, var(--muted), var(--card))" }}>
          <div className="flex items-start gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-[var(--foreground)]">My Groups</h1>
          ...
          {loading ? (
            ...
            <div className="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-5">
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      <img src="/profile.png" alt={g.name} className="h-10 w-10 rounded-full object-cover" />
                      <div>
                        <h3 className="text-lg font-extrabold text-[var(--foreground)]">{g.name}</h3>
                        {g.description && (
              ...
              <div
                onClick={() => setShowCreate(true)}
                className="bg-[var(--card)] rounded-2xl border-2 border-dashed border-[var(--border)] p-6 flex items-center justify-center hover:border-[#E94E1B] hover:bg-[#fef2ee] transition cursor-pointer"
              >
