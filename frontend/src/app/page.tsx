              ...
              <div className="grid grid-cols-3 gap-5">
                {statCards.map((card) => {
                  ...
                  return (
                    <div
                      key={card.label}
                      className="bg-[var(--card)] rounded-2xl border border-[var(--border)] shadow-[0_1px_2px_rgba(0,0,0,0.04)] p-6"
                    >
                  ...
                  <div className="space-y-3">
                    {recent.map((a) => (
                      <Link key={a._id} href={`/output/${a._id}`}>
                        <div className="flex items-center justify-between bg-[var(--card)] rounded-xl border border-[var(--border)] p-4 hover:shadow-sm transition cursor-pointer">
